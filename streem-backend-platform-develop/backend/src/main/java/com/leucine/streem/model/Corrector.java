...
@NoArgsConstructor
@Entity
@Table(name = TableName.CORRECTOR)
public class Corrector extends UserAuditIdentifiableBase implements Serializable {
  private static final long serialVersionUID = 5353529931910517186L;
