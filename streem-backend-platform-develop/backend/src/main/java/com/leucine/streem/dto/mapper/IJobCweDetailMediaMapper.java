...
import com.leucine.streem.model.JobCweDetailMediaMapping;
import org.mapstruct.Mapper;
import org.mapstruct.Mapping;
import org.springframework.beans.factory.annotation.Autowired;

@Mapper
public abstract class IJobCweDetailMediaMapper implements IBaseMapper<MediaDto, JobCweDetailMediaMapping> {
  @Autowired
  ...
  @Mapping(source = "media.archived", target = "archived")
  public abstract MediaDto toDto(JobCweDetailMediaMapping entity);
