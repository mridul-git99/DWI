...
@Mapper
public abstract class IJobAnnotationMediaMapper implements IBaseMapper<MediaDto, JobAnnotationMediaMapping> {
  @Autowired
  ...
  public abstract MediaDto toDto(JobAnnotationMediaMapping entity);
}
