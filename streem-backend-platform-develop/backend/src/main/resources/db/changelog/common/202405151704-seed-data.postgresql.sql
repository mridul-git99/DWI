...
--changeset siba:202405151704-seed-data-1
--comment: send ready task email to task assignee if all prerequisite tasks are completed of a dependant task

INSERT INTO email_templates (id, name, content)
VALUES (29, 'DEPENDANT_TASK_READY_TO_START', '<!DOCTYPE html>
<html
                          ...
                          >
                            ...
                            >
                              <span style="font-size: 20px"
                                >Ready for Action: Begin Your Task</span
                              >
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <p
                              style="font-size:14px;line-height:1.5;word-break:break-word;font-family:Nunito,Arial,&#39;Helvetica Neue&#39;,Helvetica,sans-serif;mso-line-height-alt:21px;margin:0"
                            >
                              Your task ${TaskName} of the process
                              ${ProcessName}, Job (ID:
                              <a
                                href="${JobLink}"
                                style="text-decoration: none; color: #007bff"
                                >${JobCode}</a
                              >) is ready for execution since all the
                              prerequisite tasks are completed
                              ${PreRequisiteTaskNames}. Click on the button
                          ...
                          >
                            ...
                            >
                              <span
                                ...
                                "
                                ><span
                                  style="font-size:16px;line-height:2;word-break:break-word;font-family:Nunito,Arial,&#39;Helvetica Neue&#39;,Helvetica,sans-serif;mso-line-height-alt:32px"
                                  ><span
                          ...
                          >
                            ...
                            >
                              <span style="font-size: 12px"
                                >Click the above button, or copy and paste the
                                following link on your web browser:
                          ...
                          >
                            ...
                            >
                              <span style="color: #000"
                                >To log in to Leucine, open this link in a web
