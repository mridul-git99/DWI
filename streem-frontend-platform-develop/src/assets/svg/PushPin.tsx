...
interface PushPinProps extends React.SVGProps<SVGSVGElement> {
  color?: string;
  size?: number | string;
}

const PushPin: React.FC<PushPinProps> = ({ color = '#6F6F6F', size = 24, style }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <g clip-path="url(#clip0_5167_422392)">
        <path
